...
# # Do zostawienia
# # i = 0
# # while l[i] in sudoku1[:, c]:
# #     i += 1
# # else:
# #     print(f"Element {l[i]} nie został znaleziony w wyszukiwaniu pionowym")
# # while l[i] in sudoku1[r, :]:
# #     i += 1
# # else:
# #     print(f"Element {l[i]} nie został znaleziony w wyszukiwaniu poziomym")
# # while l[i] in sudoku1[3:6, 0:3]:
# #     i += 1
# # else:
# #     print(f"Element {l[i]} nie został znaleziony w pierwszym kwadracie")
# #     sudoku1[r][c] = l[i]
# i=0
# l = [1, 2, 3, 4, 5, 6, 7, 8, 9]
# l = [int(i) for i in l]
