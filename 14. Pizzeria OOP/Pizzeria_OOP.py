class Pizza:
    ...
    składniki = ["ser", "szynka", "pieczarki", "jalapeno", "boczek", "cebula", "kukurydza", "groszek", "kabanos",
                 "pomidor", "ogórek kiszony", "tabasco", "suszone pomidory", "papryka", "parmezan", "mozzarella",
                 "bazylia", "rukola", "oregano"]
